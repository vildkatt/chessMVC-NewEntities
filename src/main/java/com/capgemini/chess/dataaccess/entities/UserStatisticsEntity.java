...
public class UserStatisticsEntity extends BaseEntity implements Serializable {
	...
	public long getNumberOfChallengesDenied() {
		return numberOfChallengesDenied;
	}

	public void setNumberOfChallengesDenied(long numberOfChallengesDenied) {
		this.numberOfChallengesDenied = numberOfChallengesDenied;
	}
